![IC Image](http://www.ti.com/graphics/folders/partimages/LDC3114.jpg)LDC3114 Example Code
=====================

The LDC3114 inductive sensing device communicates to an MCU using I2C. To assist in expediting this process, this example code is intended to show how to initialize and communicate with the LDC3114 at a high-level.
...
1.  **`LDC3114`**
	...
	*Description:* High-level functions and register map definitions for communicating with the LDC3114.
	
	*Files: LDC3114.h, LDC3114.c*

2.  **`Hardware Abstraction Layer (HAL)`**

	*Description:* The HAL provides processor specific functions called by the `LDC3114` module.
...
Reference the *LDC3114.c* file while writing your own code for examples of how how to perform basic LDC operations, such as register read/writes and reading data...

OR

Copy and paste the example code into your project, and update the files as needed to get access to the provided APIs...

 1. Copy the `LDC3114` and `HAL` module files into your firmware project.
 ...
 3. Edit all of the function implementations inside of *hal.c* to provide the specified functionality with your processor and processor-specific library APIs. 
	...
	//*****************************************************************************
	//
	//! Configures the MCU's I2C peripheral, for interfacing with the LDC3114.
	//!
	...
	void InitI2C(void)
	{
		...
		* NOTE: The LDC3114 I2C address is 0x2A.
		*/
	```
	NOTE 1: The *hal.c* functions are called from within *LDC3114.c* to interface with the hardware. The hardware functionality is kept in a separate module to allow the `LDC3114` module to remain portable.
 ...
 4. Include a reference to *hal.h* somewhere in your program and call the **InitLDC()** function to initialize the MCU peripherals connected to the LDC.

 5. Include a reference to *LDC3114.h* in your application (from *main.c* or wherever LDC communication is handled). You should now be able to begin calling the `LDC3114` module functions in your code.
...
|:-----------:| ----------- | ---------------------- |
| 1.0.0       | 8/08/2022   | Initial release        |
